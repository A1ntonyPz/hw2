...
# (Done via rails generate model commands and rails db:migrate)
...
for movie in all_movies
  ...
  puts "#{movie["title"].ljust(24)}#{movie["year_released"].to_s.ljust(15)}#{movie["rated"].ljust(7)}#{studio["name"]}"
end
